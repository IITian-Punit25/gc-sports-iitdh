...
export default function ResultsPage() {
    ...
    useEffect(() => {
        Promise.all([
            fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5000'}/api/results`).then(res => res.json()),
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="relative w-40">
                                <select
                                    ...
                                    className="w-full bg-[#1a1a1a] border border-white/10 rounded-lg px-3 py-1.5 text-white text-xs focus:border-primary focus:outline-none appearance-none cursor-pointer font-bold"
                                >
